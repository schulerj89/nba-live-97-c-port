...
- **100** functions (2.70%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **50,800** original code bytes (4.87%). Partial records do not mean the whole function is complete.
- **40** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
