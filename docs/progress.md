...
- **151** functions (4.08%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **73,368** original code bytes (7.03%). Partial records do not mean the whole function is complete.
- **91** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
