...
- **76** functions (2.05%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **42,148** original code bytes (4.04%). Partial records do not mean the whole function is complete.
- **16** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
