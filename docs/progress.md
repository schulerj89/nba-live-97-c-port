...
- **93** functions (2.51%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **49,436** original code bytes (4.73%). Partial records do not mean the whole function is complete.
- **33** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
