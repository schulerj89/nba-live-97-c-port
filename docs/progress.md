...
- **135** functions (3.65%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **66,928** original code bytes (6.41%). Partial records do not mean the whole function is complete.
- **75** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
