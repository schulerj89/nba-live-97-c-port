...
- **181** functions (4.89%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **87,672** original code bytes (8.40%). Partial records do not mean the whole function is complete.
- **122** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
