...
- **73** functions (1.97%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **41,380** original code bytes (3.96%). Partial records do not mean the whole function is complete.
- **13** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
