...
- **90** functions (2.43%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **48,416** original code bytes (4.64%). Partial records do not mean the whole function is complete.
- **30** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
