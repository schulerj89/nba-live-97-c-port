...
- **146** functions (3.94%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **70,916** original code bytes (6.79%). Partial records do not mean the whole function is complete.
- **86** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
