...
- **169** functions (4.57%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **85,396** original code bytes (8.18%). Partial records do not mean the whole function is complete.
- **110** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
