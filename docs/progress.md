...
- **114** functions (3.08%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **60,556** original code bytes (5.80%). Partial records do not mean the whole function is complete.
- **54** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
