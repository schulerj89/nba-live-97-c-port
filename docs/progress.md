...
- **123** functions (3.32%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **64,184** original code bytes (6.15%). Partial records do not mean the whole function is complete.
- **63** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
