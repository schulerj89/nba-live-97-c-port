...
- **98** functions (2.65%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **50,504** original code bytes (4.84%). Partial records do not mean the whole function is complete.
- **38** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
