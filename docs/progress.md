...
- **70** functions (1.89%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **40,716** original code bytes (3.90%). Partial records do not mean the whole function is complete.
- **10** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
