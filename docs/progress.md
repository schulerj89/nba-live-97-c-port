...
- **84** functions (2.27%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **45,724** original code bytes (4.38%). Partial records do not mean the whole function is complete.
- **24** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
