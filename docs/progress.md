...
- **97** functions (2.62%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **50,400** original code bytes (4.83%). Partial records do not mean the whole function is complete.
- **37** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
