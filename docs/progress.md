...
- **107** functions (2.89%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **58,188** original code bytes (5.57%). Partial records do not mean the whole function is complete.
- **47** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
