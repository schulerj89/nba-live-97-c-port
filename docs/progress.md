...
- **133** functions (3.59%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **66,500** original code bytes (6.37%). Partial records do not mean the whole function is complete.
- **73** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
