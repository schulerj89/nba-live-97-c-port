...
- **94** functions (2.54%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **49,808** original code bytes (4.77%). Partial records do not mean the whole function is complete.
- **34** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
