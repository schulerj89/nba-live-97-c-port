...
- **175** functions (4.73%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **85,972** original code bytes (8.23%). Partial records do not mean the whole function is complete.
- **116** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
