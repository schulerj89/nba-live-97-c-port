...
- **178** functions (4.81%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **87,176** original code bytes (8.35%). Partial records do not mean the whole function is complete.
- **119** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
