...
- **99** functions (2.67%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **50,512** original code bytes (4.84%). Partial records do not mean the whole function is complete.
- **39** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
