...
- **75** functions (2.03%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **41,500** original code bytes (3.97%). Partial records do not mean the whole function is complete.
- **15** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
