...
- **144** functions (3.89%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **70,624** original code bytes (6.76%). Partial records do not mean the whole function is complete.
- **84** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
