...
- **166** functions (4.49%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **84,188** original code bytes (8.06%). Partial records do not mean the whole function is complete.
- **107** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
