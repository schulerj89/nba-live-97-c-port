...
- **106** functions (2.86%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **56,844** original code bytes (5.44%). Partial records do not mean the whole function is complete.
- **46** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
