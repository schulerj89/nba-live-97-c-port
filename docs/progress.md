...
- **164** functions (4.43%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **78,612** original code bytes (7.53%). Partial records do not mean the whole function is complete.
- **104** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
