...
- **102** functions (2.76%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **54,128** original code bytes (5.18%). Partial records do not mean the whole function is complete.
- **42** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
