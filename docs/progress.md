...
- **140** functions (3.78%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **68,504** original code bytes (6.56%). Partial records do not mean the whole function is complete.
- **80** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
