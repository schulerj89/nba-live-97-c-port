...
- **162** functions (4.38%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **76,508** original code bytes (7.33%). Partial records do not mean the whole function is complete.
- **102** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
