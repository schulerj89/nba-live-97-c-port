...
- **87** functions (2.35%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **47,044** original code bytes (4.51%). Partial records do not mean the whole function is complete.
- **27** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
