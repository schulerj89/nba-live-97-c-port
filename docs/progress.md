...
- **85** functions (2.30%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **46,600** original code bytes (4.46%). Partial records do not mean the whole function is complete.
- **25** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
