...
- **108** functions (2.92%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **58,540** original code bytes (5.61%). Partial records do not mean the whole function is complete.
- **48** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
