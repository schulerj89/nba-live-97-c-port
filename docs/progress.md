...
- **139** functions (3.76%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **68,416** original code bytes (6.55%). Partial records do not mean the whole function is complete.
- **79** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
