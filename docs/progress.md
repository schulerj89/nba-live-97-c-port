...
- **119** functions (3.22%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **62,904** original code bytes (6.02%). Partial records do not mean the whole function is complete.
- **59** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
