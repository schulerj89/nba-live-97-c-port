...
- **105** functions (2.84%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **54,620** original code bytes (5.23%). Partial records do not mean the whole function is complete.
- **45** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
