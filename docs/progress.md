...
- **132** functions (3.57%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **66,408** original code bytes (6.36%). Partial records do not mean the whole function is complete.
- **72** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
