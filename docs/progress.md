...
- **176** functions (4.76%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **86,772** original code bytes (8.31%). Partial records do not mean the whole function is complete.
- **117** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
