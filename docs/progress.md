...
- **177** functions (4.78%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **87,008** original code bytes (8.33%). Partial records do not mean the whole function is complete.
- **118** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
