...
- **182** functions (4.92%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **88,016** original code bytes (8.43%). Partial records do not mean the whole function is complete.
- **123** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
