...
- **124** functions (3.35%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **64,200** original code bytes (6.15%). Partial records do not mean the whole function is complete.
- **64** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
