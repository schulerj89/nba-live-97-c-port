...
- **170** functions (4.59%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **85,556** original code bytes (8.19%). Partial records do not mean the whole function is complete.
- **111** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
