...
- **149** functions (4.03%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **72,036** original code bytes (6.90%). Partial records do not mean the whole function is complete.
- **89** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
