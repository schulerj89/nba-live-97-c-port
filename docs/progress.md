...
- **171** functions (4.62%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **85,572** original code bytes (8.20%). Partial records do not mean the whole function is complete.
- **112** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
