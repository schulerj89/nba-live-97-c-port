...
- **163** functions (4.40%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **78,568** original code bytes (7.53%). Partial records do not mean the whole function is complete.
- **103** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
