...
- **131** functions (3.54%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **66,336** original code bytes (6.35%). Partial records do not mean the whole function is complete.
- **71** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
