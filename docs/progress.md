...
- **136** functions (3.67%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **67,236** original code bytes (6.44%). Partial records do not mean the whole function is complete.
- **76** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
