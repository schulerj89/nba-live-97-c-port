...
- **79** functions (2.13%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **43,912** original code bytes (4.21%). Partial records do not mean the whole function is complete.
- **19** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
