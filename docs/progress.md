...
- **150** functions (4.05%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **72,864** original code bytes (6.98%). Partial records do not mean the whole function is complete.
- **90** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
