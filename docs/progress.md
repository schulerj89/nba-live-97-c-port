...
- **86** functions (2.32%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **46,748** original code bytes (4.48%). Partial records do not mean the whole function is complete.
- **26** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
