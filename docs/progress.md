...
- **129** functions (3.49%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **65,520** original code bytes (6.28%). Partial records do not mean the whole function is complete.
- **69** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
