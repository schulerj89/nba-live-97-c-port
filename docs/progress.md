...
- **101** functions (2.73%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **51,120** original code bytes (4.90%). Partial records do not mean the whole function is complete.
- **41** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
