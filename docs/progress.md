...
- **154** functions (4.16%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **74,216** original code bytes (7.11%). Partial records do not mean the whole function is complete.
- **94** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
