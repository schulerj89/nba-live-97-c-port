...
- **143** functions (3.86%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **70,380** original code bytes (6.74%). Partial records do not mean the whole function is complete.
- **83** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
