...
- **115** functions (3.11%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **60,708** original code bytes (5.81%). Partial records do not mean the whole function is complete.
- **55** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
