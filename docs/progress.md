...
- **141** functions (3.81%) have registered recomp/Ghidra/source evidence records.
- Evidence records touch **69,196** original code bytes (6.63%). Partial records do not mean the whole function is complete.
- **81** registered records claim behavior-complete scope and **0** claim instruction matching. These are catalogue counts, not totals for all recovered code.
