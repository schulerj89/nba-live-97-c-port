...
|FE919A0/92628 |Registration ignores the upload auxiliary output, keeps the pre-callback bank slot, returns constant8 after any nonnegative upload, and does not check enabled |`voice_programs.c`, mutable-callback source comparisons and `voice_programs_workflow.md`; actual upload remains required |
