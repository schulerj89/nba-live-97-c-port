...
struct Child {
 ...
 static int compress(void* u,const Nba97GameTextMemory*,const Nba97GameMatchBufferRecordEvent* e,Nba97GameMatchBufferRecordMachine* m) {
  ...
  // Explicit cursor fixture only; no encoded data or recovered compression claimed.
  m->registers.gpr[2]={self.args[2]+0x40u,15};return 1;
 }
};
}
