...
private:
    void loadRecoveredAssets() {
        ...
        trace_.log("CREATE-MODEL-DECODE", create_player_preview_->description()+
            "; 0x800687BC relocation, 0x80062F4C/0x800631B0 base transforms, and the 0x80069098 three-root hierarchy are native; 0x8006734C RTPS plus recovered camera state is numerically verified and awaits exact mocap/root scale before visible activation; textured PS1 packets remain under translation");
