...
$shortcut.Arguments = "new-tab --title `"NBA Live 97 Decomp`" --startingDirectory `"$repo`" `"$exe`""
$shortcut.WorkingDirectory = $repo
$shortcut.Description = "NBA Live 97 native original-asset boot decompilation ($Configuration)"
$shortcut.Save()
