...
try {
    ...
    foreach($test in @('team_select','team_select_poll','team_select_placement','team_ratings','user_setup','user_setup_session','user_setup_visibility','user_profiles','match_controls','match_snapshot','frontend_help','frontend_help_presentation','frontend_audio_scalars','win32_keyboard')) {
