...
try {
    ...
    foreach($target in @('nba97_game_match_initialize_tests','nba97_game_match_initialize_integration_tests',
        ...
        'nba97_game_match_buffer_pending_tests','nba97_game_match_buffer_pending_integration_tests',
        'nba97_game_match_buffer_record_tests','nba97_game_match_buffer_record_integration_tests',
        'nba97_game_match_buffer_compress_tests','nba97_game_match_buffer_compress_integration_tests',
        ...
        'nba97_game_pregame_match_card_tests','nba97_game_pregame_match_card_integration_tests',
        'nba97_game_pregame_selection_screen_tests','nba97_game_pregame_selection_screen_integration_tests',
        'nba97_game_camera_phase_select_tests','nba97_game_camera_phase_select_integration_tests',
        ...
        'nba97_game_actor_timers_tests','nba97_game_actor_timers_integration_tests',
        'nba97_game_camera_state_lookup_tests','nba97_game_camera_state_lookup_integration_tests',
        'nba97_game_text_chain_clear_tests','nba97_game_text_chain_clear_integration_tests',
        'nba97_game_image_record_upload_tests','nba97_game_image_record_upload_integration_tests',
        'nba97_game_stamina_handicap_tests','nba97_game_stamina_handicap_integration_tests',
        'nba97_game_camera_remainder_gate_tests','nba97_game_camera_remainder_gate_integration_tests',
        'nba97_game_rectangle_upload_submit_tests','nba97_game_rectangle_upload_submit_integration_tests',
        ...
        'nba97_frontend_resource_info_tests','nba97_frontend_resource_info_integration_tests',
        'nba97_gameload_bios_heap_tests','nba97_gameload_bios_heap_integration_tests',
        'nba97_gameload_main_tests','nba97_gameload_main_integration_tests',
        'nba97_frontend_resource_lookup_tests','nba97_frontend_resource_lookup_integration_tests',
        'nba97_gameload_entry_tests','nba97_gameload_entry_integration_tests',
        'nba97_frontend_resource_load_tests','nba97_frontend_resource_load_integration_tests',
        'nba97_frontend_memory_copy_tests','nba97_frontend_memory_copy_integration_tests',
        'nba97_frontend_load_payload_tests','nba97_frontend_load_payload_integration_tests',
        'nba97_frontend_overlay_load_tests','nba97_frontend_overlay_load_integration_tests',
        ...
        'nba97_frontend_exit_wait_tests','nba97_frontend_exit_wait_integration_tests',
        'nba97_frontend_exit_cleanup_tests','nba97_frontend_exit_cleanup_integration_tests',
        'nba97_frontend_main_tests','nba97_frontend_main_integration_tests',
        'nba97_frontend_dispatch_entry_tests','nba97_frontend_dispatch_entry_integration_tests',
        'nba97_frontend_dispatch_tests','nba97_frontend_dispatch_integration_tests',
