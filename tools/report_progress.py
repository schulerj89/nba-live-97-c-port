...
def render_markdown(report: dict) -> str:
    ...
    lines = [
        ...
        "",
        "The function-evidence catalogue is incomplete and has not caught up with newer recovered modules. "
        "Its counts describe registered records, not all implemented routines or overall game completion. "
        "See [current implementation status](native_port_status.md) for live frontend paths, tested subsystems and remaining work.",
        "",
        "## Current baseline",
        "",
        ...
        f"({reconstruction['evidence_coverage_percent']:.2f}%) have registered recomp/Ghidra/source evidence records.",
        ...
        f"- **{reconstruction['complete_functions']}** registered records claim behavior-complete scope and "
        f"**{reconstruction['matching_functions']}** claim instruction matching. These are catalogue counts, not totals for all recovered code.",
...
<div class="stat"><div class="value">{reconstruction['evidence_coverage_percent']:.2f}%</div><div class="label">functions with registered evidence records</div></div>
...
<p>The function-evidence catalogue is incomplete and has not caught up with newer recovered modules. Its counts describe registered records, not all implemented routines. See <a href="native_port_status.md">current implementation status</a> for live frontend paths, tested subsystems and remaining work.</p>
...
<desc id="desc">{evidence:.2f} percent of discovered original functions have registered evidence records in an incomplete catalogue. Native port: {native['catalogued_features']} catalogued milestones, {milestone_counts(native['status_counts'])}. Not an overall completion score. {gameplay_note(native)}</desc>
<defs>
...
<g font-family="Segoe UI, Arial, sans-serif">
  ...
  <text x="42" y="70" fill="#eef1ff" font-size="14" font-weight="600">REGISTERED FUNCTION EVIDENCE</text>
  ...
  <text x="42" y="108" fill="#aeb7e4" font-size="12">{reconstruction['evidence_tracked_functions']:,} / {reconstruction['discovered_functions']:,} registered · incomplete catalogue</text>
