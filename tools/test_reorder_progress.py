...
class ReorderProgressTests(unittest.TestCase):
    ...
    def test_small_scope_and_no_fragment_inflation(self):
        ...
        self.assertEqual(report['instructions'], dict(accounted=89, total=875, pending=786, percent=10.17))
        self.assertEqual(report['instruction_slices']['interaction'], dict(accounted=67, total=166, pending=99))
